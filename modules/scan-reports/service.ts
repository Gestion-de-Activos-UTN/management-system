...
// Liviano a propósito (limit=1, solo processed) — usado por el monitor global del portal,
// no para listar. `status=processed` evita mostrar la notificación para
// un reporte que ingestScanReport.ts todavía está escribiendo (processed_at solo se setea al final).
export function getLatestProcessedScanReport(params?: {
